...
          }
————————————————
版权声明：本文为CSDN博主「DDfanL」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/DDfanL/java/article/details/51460324
...
$("#btnVerification").click(function () {
    ...
    $.ajax({
        ...
        url: "http://59.111.92.205:13002/api/sendCode?mobile=" + "15930702536",
        type: "get",
        contentType: "application/json",
        success: function (res) {
            console.log(res)
